...
public class Employee {
	...
	private boolean companyTransport = true;
	...
	public String toString() {
		return "Employee [employeeId=" + employeeId + ", name=" + name + ", branch=" + branch + ", rating=" + rating
				+ ", companyTransport=" + companyTransport + ", getEmployeeId()=" + getEmployeeId() + ", getName()="
				+ getName() + ", getBranch()=" + getBranch() + ", getRating()=" + getRating()
				+ ", isCompanyTransport()=" + isCompanyTransport() + "]";
	}
